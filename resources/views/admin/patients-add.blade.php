                 ...
                 <form method="POST" action="{{ route('patients.create') }}" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         ...
                         <div class="form-check form-check-inline">
                             <input class="form-check-input" type="radio" name="status" id="pasien_active" value="active"
                                 checked>
                             <label class="form-check-label" for="pasien_active">
                                 Active
                             </label>
                         </div>
                         <div class="form-check form-check-inline">
                             <input class="form-check-input" type="radio" name="status" id="pasien_inactive"
                                 value="inactive">
                             <label class="form-check-label" for="pasien_inactive">
                                 Inactive
                             </label>
                         </div>
                     </div>
                     <div class="m-t-20 text-center">
                         <button class="btn btn-primary submit-btn" type="submit">Create pasien</button>
                     </div>
                 </form>
             </div>
         </div>
